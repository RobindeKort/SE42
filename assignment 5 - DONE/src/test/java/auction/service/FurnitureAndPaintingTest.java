...
//        assertFalse(it.hasNext());
    ...
    // Opdracht 5: 
    // Database zonder Inheritance implementatie 
    // bid, item, sequence, users
    
    // Opdracht 6:
    // Database met Inheritance Joined
    // bid, furniture, item, painting, sequence, users
    
    // Opdracht 7: 
    // Database with Inheritance TABLE_PER_CLASS -- werkte niet aangezien find hier niet werkt
    ...
    //Database met @Inheritance SINGLE_TABLE
    //bid, item, sequence, users

    //Database met @Inheritance TABLE_PER_CLASS -- werkte niet aangezien find hier niet werkt
    //bid, furniture, item, painting, sequence, users
}
