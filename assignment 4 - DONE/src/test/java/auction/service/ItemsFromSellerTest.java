...
public class ItemsFromSellerTest {
 ...
 //   @Ignore
    public void numberOfOfferdItems() {
         ...
         *  De juiste is de tweede omdat in de persistance context van de gebruiker heeft maar 1 Item dus de tweede is correct
         */
         ...
         *  QUESTION:
         *  Explain the result in terms of entity manager and persistance context.
         *  De eerste is hier goed, want in deze persistance context is het hier het juiste geval, 
            de USer heeft op dit punt 2 items en dus is eerste juiste.  
         */
