 ...
 * 
 */
@WebServiceClient(name = "RegistrationService", targetNamespace = "http://web/", wsdlLocation = "http://localhost:8080/Registration?WSDL")
    ...
    extends Service
{
    ...
    private final static QName REGISTRATIONSERVICE_QNAME = new QName("http://web/", "RegistrationService");
    ...
    public Registration getRegistrationPort() {
        return super.getPort(new QName("http://web/", "RegistrationPort"), Registration.class);
    }
    ...
    public Registration getRegistrationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web/", "RegistrationPort"), Registration.class, features);
    }
