...
public class ObjectFactory {
    ...
    private final static QName _RegisterUserResponse_QNAME = new QName("http://web/", "registerUserResponse");
    private final static QName _RegisterUser_QNAME = new QName("http://web/", "registerUser");
    private final static QName _GetUser_QNAME = new QName("http://web/", "getUser");
    private final static QName _GetUserResponse_QNAME = new QName("http://web/", "getUserResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web/", name = "registerUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web/", name = "registerUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web/", name = "getUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web/", name = "getUserResponse")
